...
public class SpatialPattern {
    ...
    private static final OntologyClass CERVICAL_NECK = OntologyClassBuilder.ontologyClass("HP:0032535", "Cervical (neck)");
    ...
    private static final OntologyClass SPATIAL_PATTERN = OntologyClassBuilder.ontologyClass("HP:0012836", "Spatial pattern");
    ...
    /** Do not allow instation of the constructor, this class just provides constants from the HPO
     * Spatial Pattern subhierarchy, which is in the Clinical modifier subhierarchy.
     */
    private SpatialPattern() {}
    ...
    public static OntologyClass spatialPattern() { return SPATIAL_PATTERN; }
    ...
    public static OntologyClass cervicalNeck() { return CERVICAL_NECK; }
