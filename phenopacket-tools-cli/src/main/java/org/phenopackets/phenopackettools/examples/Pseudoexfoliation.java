...
implantation in the right eye (OD) in January 2006.
     ...
     */
        ...
        TimeElement age = TimeElements.age("P70J7W");// One week added to the patient's age. Is that how it works?
        ...
        // Refraction after 1 week right eye -0.25/-0.5/110 degrees
            ...
            Value rightEyeValue = ValueBuilder.of(Unit.diop(), -0.5, ref);
            //	Right eye Axis: LOINC 9829-8
            TimeElement age = TimeElements.age("P70J"); //Druckerhöhung 1J1M nach Cataractsurgery
    ...
    */
    ...
    List<Measurement> getMeasurements() {
        ...
        TimeElement age = TimeElements.age("P71J1M"); //Druckerhöhung 1J1M nach Cataractsurgery
...
// Anterior chamber depth was 3.93 mm. The PC/IOL was sitting in the capsular bag OS, and the anterior chamber depth was 5.21 mm
                ...
                Measurement visusMeasurement = MeasurementBuilder
                        .builder(visionAssessment, ComplexValueBuilder.of(visus100)).build();
                TimeElement age = TimeElements.age("P71J1M"); //Visual acuity 1J1M after Cataractsurgery
            }
